...
function theme_options_add_page() {
    add_theme_page( __( 'Настройка темы', 'sampletheme' ), __( 'Настройка темы', 'sampletheme' ), 'edit_theme_options', 'theme_options', 'theme_options_do_page' );
}
/**
    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                 ...
                 */
                ?>
                <tr valign="top"><th scope="row"><?php _e( 'Логотип', 'sampletheme' ); ?></th>
                    <td>
